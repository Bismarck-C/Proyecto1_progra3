 ...
 * @author Dylan M
 */
public class frmModificarU extends javax.swing.JFrame {

    UsuarioInterface userController;
    
        
    public frmModificarU() {
    ...
    private void initComponents() {
        ...
        labelTitle.setText("MODIFICAR INFORMACION DE USUARIO EN EL SISTEMA");
        jPanel1.add(labelTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(262, 86, -1, -1));
        ...
        jPanel1.add(btnAceptar, new org.netbeans.lib.awtextra.AbsoluteConstraints(273, 370, 123, 40));
        ...
        jPanel1.add(btnVolver, new org.netbeans.lib.awtextra.AbsoluteConstraints(587, 370, 123, 40));

        txtId.setForeground(java.awt.Color.lightGray);
        txtId.setText("Digite su identificacion");
        txtId.setToolTipText("Digite el id del usuario a modificar");
        ...
        jPanel1.add(txtId, new org.netbeans.lib.awtextra.AbsoluteConstraints(253, 120, 165, 36));

        txtNombre.setForeground(java.awt.Color.lightGray);
        txtNombre.setText("Digite su nombre");
        txtNombre.setToolTipText("Digite su neuvo nombre");
        ...
        jPanel1.add(txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(563, 120, 165, 36));
        jPanel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(563, 162, 165, 10));
        jPanel1.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(563, 162, 165, 10));

        txtTelefono.setForeground(java.awt.Color.lightGray);
        txtTelefono.setText("Digite su telefono");
        txtTelefono.setToolTipText("Digite su nuevo telefono");
        ...
        jPanel1.add(txtTelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(563, 184, 165, 36));

        txtApellidos.setForeground(java.awt.Color.lightGray);
        txtApellidos.setText("Digite sus apellidos");
        txtApellidos.setToolTipText("Digite sus nuevos apellidos");
        ...
        jPanel1.add(txtApellidos, new org.netbeans.lib.awtextra.AbsoluteConstraints(253, 184, 165, 36));

        jSeparator3.setForeground(java.awt.Color.black);
        jPanel1.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(253, 226, 165, 10));

        jSeparator4.setForeground(java.awt.Color.black);
        jPanel1.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(563, 226, 165, 10));

        txtCorreo.setForeground(java.awt.Color.lightGray);
        txtCorreo.setText("Digite su correo electronico");
        txtCorreo.setToolTipText("Digite su nuevo correo electronico");
        ...
        jPanel1.add(txtCorreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(253, 242, 475, 36));

        jSeparator5.setForeground(java.awt.Color.black);
        jPanel1.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(253, 284, 475, 10));

        txtUsuario.setForeground(java.awt.Color.lightGray);
        txtUsuario.setText("Digite su usuario");
        txtUsuario.setToolTipText("Digite su nuevo usuario");
        ...
        jPanel1.add(txtUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(253, 300, 165, 36));

        jSeparator6.setForeground(java.awt.Color.black);
        jPanel1.add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(253, 342, 165, 10));

        txtPassword.setForeground(java.awt.Color.lightGray);
        txtPassword.setText("12345678");
        txtPassword.setToolTipText("Digite su nueva contrasena");
        ...
        jPanel1.add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(562, 300, 166, 36));

        jSeparator7.setForeground(java.awt.Color.black);
        jPanel1.add(jSeparator7, new org.netbeans.lib.awtextra.AbsoluteConstraints(562, 342, 165, 10));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 980, 69));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 510, 980, 70));

        jSeparator8.setForeground(java.awt.Color.black);
        jPanel1.add(jSeparator8, new org.netbeans.lib.awtextra.AbsoluteConstraints(253, 162, 165, 10));
    ...
    private void btnAceptarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAceptarMouseClicked
        if(!this.txtId.getText().startsWith("D")){
            ...
            if(userController.updateUser(data)){
                JOptionPane.showMessageDialog(this,"Modificado correctamente","Usuario",JOptionPane.INFORMATION_MESSAGE);
            }
            else{
    ...
    private void txtIdKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtIdKeyReleased
        Usuario user = userController.getById(txtId.getText());
        if(user!=null){
            this.txtNombre.setText(user.getNombre());
            this.txtApellidos.setText(user.getApellidos());
            this.txtCorreo.setText(user.getEmail());
            this.txtTelefono.setText(user.getTelefono());
            this.txtUsuario.setText(user.getTelefono());
